...
- [Exitalk](https://www.superpung.xyz/)
...
```xml
<script src="https://cdn.jsdelivr.net/gh/SuperPung/super_live2d@latest/autoload.js"></script>
```
...
```xml
<script src="https://cdn.jsdelivr.net/gh/username/live2d@latest/autoload.js"></script>
```
...
## Thanks [张书樵](https://zhangshuqiao.org)
